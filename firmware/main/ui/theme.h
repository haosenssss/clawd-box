...
#define SPRITE_SCALE 14.9f   /* 15 单位宽 -> 224px，与额度条同宽同轴 */
#define SPRITE_BASELINE_Y 236
...
/*
 * 项目名的字号是**固定的**，与底部额度栏同档。
 * 不随名字长短变——同一个位置在不同项目之间字号忽大忽小，界面就不稳。
 * 放不下就折行，绝不缩字。
 */
#define NAME_SCALE 2
/* 状态词紧跟项目名——"哪个项目"和"它在干嘛"是一组信息，
 * 中间拉开就散了；真正该留白的是这一组和底部数据之间。 */
#define VERB_Y 310
#define BAR_LABEL_CX 54       /* 标签列中心（0..条子左缘 之间居中） */
#define BAR_X 128              /* = 精灵左边缘，两者必须等宽同轴 */
/*
